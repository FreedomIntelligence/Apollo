...
Options:
{options}
Assistant:The correct answer is {answer}.</s>
"""
...
Opciones:
{options}
Assistant:La respuesta correcta es {answer}.</s>
"""
...
Possibilités:
{options}
Assistant:La bonne réponse est {answer}.</s>
"""
...
विकल्प:
{options}
Assistant:सही उत्तर है{answer}.</s>
"""
...
خيارات:
{options}
Assistant:{answer}الإجابة الصحيحة هي.</s>
"""
    ...
    for source, items in grouped_items.items():
        ...
        for item in items:
            ...
            for sample in random_samples:
                if len(question) + real_question_len < 4096:
