...
python ../OpenAIGPT_datagen_multithread.py --keys_path ../gpt4key.txt --input_path ./data/2.guideline_other_prepared.jsonl  --output_path ./data/3.guideline_other_aftgpt.jsonl --max_workers 300
